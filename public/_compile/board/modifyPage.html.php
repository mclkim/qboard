<?php /* Template_ 2.2.8 2016/05/25 22:17:37 C:\phpdev\workspace\qboard\public\_template\board\modifyPage.html 000004177 */ ?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="?board.modifyPost" method="post">
                    ...
                    <script>
                        $(document).ready(function () {
                            ...
                            $(".btn-warning").on("click", function () {
                                self.location = "?board.listPage&page=<?php echo $TPL_VAR["cri"]["page"]?>&perPageNum=<?php echo $TPL_VAR["cri"]["perPageNum"]?>";
                            });
